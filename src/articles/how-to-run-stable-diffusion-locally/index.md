...
There are many Docker images created by the community. You need to find the one
that suits your needs by checking
...
I recommend using
[base image from Vast.ai](https://github.com/vast-ai/base-image). It's well
maintained and gives you ability to use cool
[Provisioning Scripts](https://github.com/vast-ai/base-image?tab=readme-ov-file#applications--startup)
