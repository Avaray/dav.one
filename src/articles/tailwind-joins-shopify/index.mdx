...
<HeadingWithIcon icon="game-icons:robot-antennas" title="From Layoffs to a Landing" level={2} iconSize='xl' />
...
<HeadingWithIcon icon="game-icons:uprising" title="How the Community Reacted" level={2} iconSize='xl' />
...
<HeadingWithIcon icon="game-icons:trail" title="What This Means" level={2} iconSize='xl' />
