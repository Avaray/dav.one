...
You can use the native Astro Fonts API to easily add custom fonts to your project.
This will let you use web fonts from Google Fonts or local fonts by simply providing the font names and configuring the providers.

Since this is an experimental feature (as of Astro 5.7.0), you must enable it and configure your fonts in the **astro.config.mjs** config file. 
