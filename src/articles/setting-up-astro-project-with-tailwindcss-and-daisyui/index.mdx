...
By default, [Tailwind CSS](https://tailwindcss.com/docs/preflight) resets all styles. If you're planning to create a [blog](https://en.wikipedia.org/wiki/Blog) or other text-based content, you should consider adding typography plugin.
...
I recommend reading [official documentation](https://github.com/tailwindlabs/tailwindcss-typography?tab=readme-ov-file#basic-usage) and [this page of daisyUI](https://daisyui.com/docs/layout-and-typography/) to learn more.  
...
[astro-iconify-component](https://github.com/Avaray/astro-iconify-component) is a package I created to make it easy to use [SVG](https://developer.mozilla.org/en-US/docs/Web/SVG) icons in [Astro](https://astro.build/) projects. It gives you access to all icons from [Iconify](https://iconify.design/) (over 300,000 open-source vector icons).

While there are various [existing packages](https://astro.build/integrations/?search=iconify) for Iconify, they often fall short: some lack the newest icons, others rely on dynamic `fetch` calls (which can cause Iconify to block your requests during development if your project uses many icons), and the official Iconify package requires too much configuration for everyday use. I created `astro-iconify-component` as a simple, hassle-free solution to address all of these problems.
