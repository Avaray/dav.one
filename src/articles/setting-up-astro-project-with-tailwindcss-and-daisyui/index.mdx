...
<div class="flex flex-col md:flex-row items-center border p-8 rounded-3xl mt-12 bg-clampography-surface overflow-hidden">
  <div><Icon icon="game-icons:coronation" class='h-40 w-40 text-clampography-primary' /></div>
  <div class="flex flex-col">
    <div class='flex gap-6 text-5xl mt-6 font-bold text-clampography-primary animate-bounce transform -translate-x-[52px]'>
