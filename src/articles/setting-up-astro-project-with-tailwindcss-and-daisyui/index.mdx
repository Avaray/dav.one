...
Check out [official documentation](https://iconify.design/docs/usage/svg/astro/) for more information.
...
For this tutorial, we will add React and Vue to our project. 
