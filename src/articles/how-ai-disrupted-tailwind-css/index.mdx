...
<Alert type="success" noicon>
  🎉 **Update 09.09.2026** - Tailwind is officially joining [Shopify](https://www.shopify.com/). Adam Wathan [announced](https://tailwindcss.com/blog/tailwind-is-joining-shopify) that this move gives Tailwind a stable, long-term home where it will be actively maintained. While the framework and all open-source projects remain MIT-licensed, Tailwind is closing sign-ups for new commercial customers to focus entirely on building in service of Shopify's real-world ecosystem. Read the original analysis below to understand the crisis that led to this major transition.
</Alert>
