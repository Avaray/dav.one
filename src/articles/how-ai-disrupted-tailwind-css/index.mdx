...
> **UPDATE:** Big news — Tailwind is officially joining Shopify. Adam Wathan announced that this move gives Tailwind a stable, long-term home where it will be actively maintained[cite: 1]. While the framework and all open-source projects remain MIT-licensed, Tailwind is closing sign-ups for new commercial customers (existing customers maintain access) to focus entirely on building in service of Shopify's real-world ecosystem[cite: 1]. Read the original analysis below to understand the crisis that led to this major transition.
