...
<div class='group flex items-center my-12 gap-4' {...props}>
  <div><Icon name="game-icons:thumb-up" class='h-40 w-40 text-clampography-primary transition-transform duration-300 ease-in-out group-hover:-translate-y-4 group-hover:-rotate-12 origin-bottom' /></div>
