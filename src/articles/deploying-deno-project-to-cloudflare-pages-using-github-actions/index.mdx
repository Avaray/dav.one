...
Name can be anything, but the extension must be `.yml`
...
<div class='group flex items-center my-12 gap-4' {...props}>
  <div><Icon icon="game-icons:thumb-up" class='h-40 w-40 text-clampography-primary transition-transform duration-300 ease-in-out group-hover:-translate-y-4 group-hover:-rotate-12 origin-bottom' /></div>
  <div class='flex flex-col'>
    <div class='flex gap-6 text-5xl mt-6 font-bold text-clampography-primary'>
