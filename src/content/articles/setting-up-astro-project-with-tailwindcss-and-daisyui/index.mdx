...
Edit the **astro.config.mjs** file, located in the root of your project. You need to add [TailwindCSS](https://tailwindcss.com/docs/installation/using-vite) as a [Vite plugin](https://docs.astro.build/en/recipes/add-yaml-support/).
