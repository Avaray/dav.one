...
<div role="alert" class="alert alert-warning alert-soft">
  ...
  <span>
    Starting from Astro version 5.7.0, <a href="https://docs.astro.build/en/reference/experimental-flags/fonts/" target='_blank'>Experimental fonts API</a> is available.
  </span>
</div>
