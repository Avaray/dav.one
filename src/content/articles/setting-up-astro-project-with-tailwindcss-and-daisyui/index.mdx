...
<div role="alert" class="alert alert-warning alert-soft text-lg w-fit">
  <span>Warning: This article is based on Beta versions. It will be updated once the stable versions are officially released.</span>
</div>
...
Setup a project as you like. **Just don't install dependencies in setup process.** You will do that later.
...
export const dependencies = [
  { label: "Deno", content: "deno i --allow-scripts npm:vite@latest npm:tailwindcss@next npm:@tailwindcss/vite@next\ndeno i -D npm:daisyui@beta" },
  { label: "Bun", content: "bun i vite@latest tailwindcss@next @tailwindcss/vite@next\nbun i -D daisyui@beta" },
  { label: "NPM", content: "npm i vite@latest tailwindcss@next @tailwindcss/vite@next\nnpm i -D daisyui@beta" },
  { label: "PNPM", content: "pnpm add vite@latest tailwindcss@next @tailwindcss/vite@next\npnpm add -D daisyui@beta" },
  { label: "Yarn", content: "yarn add vite@latest tailwindcss@next @tailwindcss/vite@next\nyarn add -D daisyui@beta" },
];
...
Edit **astro.config.mjs** file located in the root of your project. You need to add [TailwindCSS](https://tailwindcss.com/) as a [Vite plugin](https://docs.astro.build/en/recipes/add-yaml-support/).
...
Then import CSS file in **.astro** component like:
```yaml
---
...
Another way to import CSS file in **.astro** component:
...
<div class='flex items-center my-12 gap-4' {...props}>
  ...
  <div class='flex flex-col'>
    ...
    <div>
        At this moment you should be able to use **TailwindCSS** and **daisyUI** in your project.  
...
In case of this tutorial, we will add [React](https://react.dev/) framework manually.  
...
Edit **astro.config.mjs** configuration file again. Add [React](https://react.dev/) to [integrations list](https://docs.astro.build/en/guides/integrations-guide/#manual-installation).
...
If you are using [TypeScript](https://www.typescriptlang.org/docs/) in your project, then you need to edit **tsconfig.json** file located in the root of your project.  
Add following lines to **compilerOptions** section.
...
If you chose **Basic, minimal starter** at the beginning of this tutorial, then you may also consider following integrations.  
I will not cover them in this tutorial, but I believe you will be able to add them by yourself.
