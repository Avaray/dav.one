...
<div role="alert" class="alert alert-warning alert-soft w-fit font-bold">
  <span>I’ve just discovered that in new projects, this option is no longer there. The new settings are more confusing than the old ones. I’ll update these instructions as soon as I find out where this setting is located.</span>
</div>
