...
description: 'The biggest influence on how the generated people will look comes from the model we use and our well-written prompts. We can modify the face, body, and clothing by using simple prompts. In this article I will describe how to modify the face and body without using Loras, Positive Textual Inversions, ControlNet, etc. Just pure prompts.'
created: 'Jul 31 2023'
